...
struct Config {
    ...
    /**
     * Do not process input images where the number of channels exceeds this
     * limit. Assumes image metadata can be trusted.
     * Defaults to `5`, set to `0` to remove the limit.
     * weserv_limit_input_channels 5;
     */
    ...
    /**
     * The default quality to use for JPEG XL images.
     * NOTE: Can be overridden with `&q=`.
     * weserv_jxl_quality 80;
     */
    intptr_t jxl_quality;
    ...
    /**
     * Controls the CPU effort spent on improving JPEG XL compression.
     * Defaults to 7.
     * weserv_jxl_effort 7;
     */
    intptr_t jxl_effort;
